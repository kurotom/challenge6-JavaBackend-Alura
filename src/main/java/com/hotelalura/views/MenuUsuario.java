...
//					MenuUsuario frame = new MenuUsuario();					
					MenuUsuario frame = new MenuUsuario(funcionario);
...
//								
		...
		labelRegistro.setBounds(25, 11, 230, 34);
...
//  ---------->        
//				
				Busqueda busqueda = new Busqueda(funcionario);
	    ...
	    lblNewLabel.setBounds(290, 234, 160, 46);
...
//    
//    
    private String nameTitleFormatted(String nombre) {
		StringBuilder buiderAlgo = new StringBuilder("");
		buiderAlgo.append(nombre.toUpperCase().charAt(0));	
		buiderAlgo.append(nombre.substring(1, nombre.length()));
		
		String nameTitle = buiderAlgo.toString();
    	return nameTitle;
    }
}
